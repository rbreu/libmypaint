...
static MyPaintBrushSettingInfo settings_info_array[] = {
    ...
    {"offset_angle", N_("Angular Offset Side"), FALSE, -20.0, 0.0, 20.0, N_("Follows the stroke direction to offset the dabs to one side.")}, 
    {"offset_angle_2", N_("Angular Offset Mirrored"), FALSE, 0.0, 0.0, 40.0, N_("Follows the stroke direction to offset the dabs, but to both sides of the stroke.")}, 
